package net.mrmisc.essenceofthewild.entity.custom.cow;// Made with Blockbench 5.1.1
...
public class CowModel<T extends Entity> extends HierarchicalModel<CowEntity> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		.texOffs(82, 105).addBox(-2.0F, -10.0F, -10.0F, 4.0F, 5.0F, 9.0F, new CubeDeformation(0.0F))
		...
		.texOffs(101, 0).addBox(-1.0F, 5.0F, -4.0F, 2.0F, 6.0F, 6.0F, new CubeDeformation(0.0F))
		.texOffs(109, 120).addBox(-1.0F, 11.0F, -4.0F, 2.0F, 2.0F, 6.0F, new CubeDeformation(0.0F))
	...
	@Override
	public void setupAnim(CowEntity pEntity, float pLimbSwing, float pLimbSwingAmount, float pAgeInTicks, float pNetHeadYaw, float pHeadPitch) {
